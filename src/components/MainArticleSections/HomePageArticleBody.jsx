    ...
    <>
      <article>
        <section aria-label="Spiegazione su cosa sono le console">
          ...
          <p className="text-xl">
            <b>Le console videoludiche</b> sono dispositivi che hanno
            trasformato il concetto di intrattenimento nel corso dei decenni.
            Esse sono, in sostanza, computer specializzati nel riprodurre
            giochi, ma con l'obiettivo principale di essere
          ...
          <p className="text-xl">
            ...
            milioni di persone nel mondo: Nintendo, Sony e Microsoft, con le
            loro iconiche console, hanno contribuito a creare una{" "}
            <b>
        ...
        <section aria-label="Storia della nascita delle console">
          ...
          <p className="text-xl">
            Dagli anni '90 subentrarono Sony con la <b>PlayStation</b> e
            Microsoft con <b>l’Xbox</b>: si cercava di spingere la tecnologia
            sempre oltre i limiti e questo portò all’introduzione della grafica
            3D, giochi sempre più complessi e connettività online, ecc, dando
            vita ad una competizione che ha definito il panorama videoludico
            moderno. Ogni generazione di console ha portato con se una serie di
            sviluppi, come i controller sempre più ergonomici e pregni di
            funzionalità e le esperienze in realtà virtuale.
          </p>
        </section>
        ...
        <section aria-label="Spiegazione sulla crisi videoludica del 1983">
          ...
          <p className="text-xl">
            La crisi ebbe un impatto minore in Giappone ed Europa, dove il
            mercato videoludico continuò a crescere. Nel 1985, Nintendo ha
            introdotto il <b>Nintendo Entertainment System (NES)</b> nel mercato
            nordamericano, riportando l'industria in ripresa. Il successo del
            NES segnò l'inizio di una nuova era caratterizzata da giochi
            sviluppati con qualità superiore e maggior attenzione ai
            consumatori.
          </p>
          <p className="text-xl">
        ...
        <section aria-label="Elenco degli eventi più importanti durante la storia delle console videoludiche">
          ...
          <p className="text-xl">
            Quali sono stati gli eventi più importanti che hanno segnato al
            storia del medium videoludico? Quali sono le console che hanno
            segnato la storia del gaming? Ecco una Timeline.
          </p>
...
export default HomePageArticleBody;
